...
extension TodoQueryFilter on QueryBuilder<Todo, Todo, QFilterCondition> {
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> descripionIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> descripionIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'descripion',
      ));
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> descripionEqualTo(
    String? value, {
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> descripionGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> descripionLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> descripionBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> descripionStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> descripionEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> descripionContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> descripionMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> descripionIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'descripion',
        value: '',
  ...
  QueryBuilder<Todo, Todo, QAfterFilterCondition> descripionIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'descripion',
        value: '',
...
extension TodoQuerySortBy on QueryBuilder<Todo, Todo, QSortBy> {
  ...
  QueryBuilder<Todo, Todo, QAfterSortBy> sortByDescripion() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'descripion', Sort.asc);
    });
  }

  QueryBuilder<Todo, Todo, QAfterSortBy> sortByDescripionDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TodoQuerySortThenBy on QueryBuilder<Todo, Todo, QSortThenBy> {
  ...
  QueryBuilder<Todo, Todo, QAfterSortBy> thenByDescripion() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'descripion', Sort.asc);
    });
  }

  QueryBuilder<Todo, Todo, QAfterSortBy> thenByDescripionDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'descripion', Sort.desc);
    });
  }
...
extension TodoQueryWhereDistinct on QueryBuilder<Todo, Todo, QDistinct> {
  ...
  QueryBuilder<Todo, Todo, QDistinct> distinctByDescripion(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension TodoQueryProperty on QueryBuilder<Todo, Todo, QQueryProperty> {
  ...
  QueryBuilder<Todo, String?, QQueryOperations> descripionProperty() {
    return QueryBuilder.apply(this, (query) {
